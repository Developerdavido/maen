  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
          itemCount: user.sellerOrders.length,
          itemBuilder: (_, index){
            OrderModel _order = user.sellerOrders[index];
            return GestureDetector(
              onTap: () async {
                await user.loadAddressByOrder(addressId: user.sellerOrders[index].address, userId: user.sellerOrders[index].userId);
                changeScreen(context,
                    OrderDetail(order: user.sellerOrders[index]));
              },
              child: Padding(
